...
import { createEvent, getAllEvents, getMyEvents, registerForEvent, openEvent } from "../controllers/events.controller.js";
...
router.put("/:id/open", authMiddleware, adminMiddleware, openEvent);
